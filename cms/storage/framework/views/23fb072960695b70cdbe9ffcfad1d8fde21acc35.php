            ...
            <div class="sdbox" id="<?php echo e($post->id); ?>">
                ...
                <div class="sdchild">
                    <div class="sdinfo">
                        ...
                        <form action="<?php echo e(url('/bookmark/del')); ?>" method="POST">
                            <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/shisha_/cms/resources/views/bookmark.blade.php ENDPATH**/ ?>